// NPM: textcomplete@0.18.0
//
// Compiled with custom settings so that the Textcomplete global is always defined.
// This allows Thredded code to be compatible with both Webpack and Sprockets.
//
/* Compiled like this:

git clone https://github.com/yuku/textcomplete.git && cd textcomplete
yarn remove babel babel-cli
tee package.json << END
{
  "name": "textcomplete",
  "dependencies": {
    "eventemitter3": "^2.0.3",
...
(function () {
        ...
        value: function execute(callback) {
          ...
          this.strategy.search(this.term, function (results) {
            callback(results.map(function (result) {
              return new SearchResult(result, _this.term, _this.strategy);
            }));
          }, this.match);
        }
      }]);
  ...
  var Completer =
    ...
    function (_EventEmitter) {
      ...
      function Completer() {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(Completer).call(this));
        _this.strategies = [];
      ...
      _createClass(Completer, [{
        ...
        value: function extractQuery(text) {
          for (var i = 0; i < this.strategies.length; i++) {
            var query = Query.build(this.strategies[i], text);
    ...
    if (typeof window.CustomEvent === "function") {
      ...
      return function (type, options) {
        ...
        event.initCustomEvent(type,
          /* bubbles */
          false, options && options.cancelable || false, options && options.detail || undefined);
        return event;
      };
    }
  }();
  ...
  function getLineHeightPx(node) {
    var computedStyle = window.getComputedStyle(node); // If the char code starts with a digit, it is either a value in pixels,
    // or unitless, as per:
    ...
    function (_EventEmitter) {
      ...
      _createClass(Editor, [{
        ...
        value: function emitEnterEvent() {
          var enterEvent = createCustomEvent("enter", {
            cancelable: true
          });
        ...
        value: function emitEscEvent() {
          var escEvent = createCustomEvent("esc", {
            cancelable: true
          });
  ...
  var DEFAULT_CLASS_NAME = "textcomplete-item";
  var CALLBACK_METHODS$1 = ["onClick", "onMouseover"];
  /** @typedef */
  ...
  var DropdownItem =
    ...
    function () {
      function DropdownItem(searchResult, options) {
        ...
        this.activeClassName = "".concat(this.className, " active");
        CALLBACK_METHODS$1.forEach(function (method) {
  ...
  var DEFAULT_CLASS_NAME$1 = "dropdown-menu textcomplete-dropdown";
  /** @typedef */
  ...
  var Dropdown =
    ...
    function (_EventEmitter) {
      ...
      function Dropdown(options) {
        ...
        _this.el.className = options.className || DEFAULT_CLASS_NAME$1;
      ...
      _createClass(Dropdown, [{
        ...
        value: function render(searchResults, cursorOffset) {
          ...
          var renderEvent = createCustomEvent("render", {
            cancelable: true
          });
          ...
          var dropdownItems = searchResults.slice(0, this.maxCount || searchResults.length).map(function (searchResult) {
            return new DropdownItem(searchResult, _this2.itemOptions);
          });
        ...
        value: function select(dropdownItem) {
          var detail = {
            searchResult: dropdownItem.searchResult
          };
          var selectEvent = createCustomEvent("select", {
            cancelable: true,
            detail: detail
          });
          ...
          this.deactivate();
          this.emit("selected", createCustomEvent("selected", {
            detail: detail
          }));
          return this;
        }
        ...
        value: function setOffset(cursorOffset) {
          ...
          if (doc) {
            ...
            if (cursorOffset.left) {
              ...
              this.el.style.left = "".concat(cursorOffset.left, "px");
            } else if (cursorOffset.right) {
              if (cursorOffset.right - elementWidth < 0) {
                cursorOffset.right = 0;
              }

              this.el.style.right = "".concat(cursorOffset.right, "px");
            }
            ...
            if (this.isPlacementTop() || forceTop) {
              this.el.style.bottom = "".concat(doc.clientHeight - cursorOffset.top + cursorOffset.lineHeight, "px");
              this.el.style.top = "auto";
            } else {
              this.el.style.top = "".concat(cursorOffset.top, "px");
        ...
        value: function show() {
          if (!this.shown) {
            var showEvent = createCustomEvent("show", {
              cancelable: true
            });
        ...
        value: function hide() {
          if (this.shown) {
            var hideEvent = createCustomEvent("hide", {
              cancelable: true
            });
        ...
        value: function renderEdge(rawResults, type) {
          ...
          var li = document.createElement("li");
          li.classList.add("textcomplete-".concat(type));
  ...
  var CALLBACK_METHODS$2 = ["handleChange", "handleEnter", "handleEsc", "handleHit", "handleMove", "handleSelect"];
  /** @typedef */
  ...
  var Textcomplete =
    ...
    function (_EventEmitter) {
      ...
      function Textcomplete(editor) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(Textcomplete).call(this));
        _this.completer = new Completer();
        _this.isQueryInFlight = false;
        _this.nextPendingQuery = null;
        _this.dropdown = new Dropdown(options.dropdown || {});
        _this.editor = editor;
        _this.options = options;
        CALLBACK_METHODS$2.forEach(function (method) {
          _this[method] = _this[method].bind(_assertThisInitialized(_this));
        });
      ...
      _createClass(Textcomplete, [{
        ...
        value: function register(strategyPropsArray) {
          ...
          strategyPropsArray.forEach(function (props) {
            _this2.completer.registerStrategy(new Strategy(props));
          });
          return this;
        }
        /**
  ...
  var update = createCommonjsModule(function (module, exports) {
    ...
    exports["default"] = function (el, headToCursor, cursorToTail) {
      var curr = el.value,
        ...
        // strA + strB2 + strC
        activeElement = document.activeElement; //  Calculate length of strA and strC
      ...
      var strB2 = next.substring(aLength, next.length - cLength); // Replace strB1 with strB2
  ...
  var update$1 = unwrapExports(update);

  var getCaretCoordinates = require("textarea-caret");

  var CALLBACK_METHODS$3 = ["onInput", "onKeydown"];
  /**
  ...
  var Textarea =
    ...
    function (_Editor) {
      ...
      function Textarea(el) {
        ...
        _this.el = el;
        CALLBACK_METHODS$3.forEach(function (method) {
          _this[method] = _this[method].bind(_assertThisInitialized(_this));
        });
      ...
      _createClass(Textarea, [{
        key: "destroy",
        value: function destroy() {
          _get(_getPrototypeOf(Textarea.prototype), "destroy", this).call(this);

          this.stopListening() // Release the element reference early to help garbage collection.
          ;
          this.el = null;
          return this;
        }
        ...
        value: function applySearchResult(searchResult) {
          ...
          if (before != null) {
            ...
            if (Array.isArray(replace)) {
              update$1(this.el, replace[0], replace[1]);
        ...
        value: function getCursorOffset() {
          ...
          var lineHeight = getLineHeightPx(this.el);
  ...
  if (global$1.Textcomplete && global$1.Textcomplete.editors) {
    editors = global$1.Textcomplete.editors;
  } else {
    editors = {};
  }

  editors.Textarea = Textarea;
  global$1.Textcomplete = Textcomplete;
  global$1.Textcomplete.editors = editors;
